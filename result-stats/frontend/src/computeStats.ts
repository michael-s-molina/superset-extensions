import { common } from '@apache-superset/core';
import {
  ColumnStats,
  ResultStats,
  NumericStats,
...
export const computeStats = (
  ...
  const columnStats: ColumnStats[] = columns.map(col => {
    ...
    const isString = col.type_generic === common.GenericDataType.String;
    ...
    switch (typeGeneric) {
      case common.GenericDataType.Numeric:
        numericStats = getNumericStats(values, rowCount);
        break;
      case common.GenericDataType.String:
        stringStats = getStringStats(values);
        break;
      case common.GenericDataType.Temporal:
        temporalStats = getTemporalStats(values);
        break;
      case common.GenericDataType.Boolean:
